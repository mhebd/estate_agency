      ...
      <div className="container">
          ...
          <div className="row">
            <div className="col-lg-6 mb-4">
              <div className="header">
                <h2 className="heading">304 Blaster Up</h2>
            ...
            <div className="col-lg-6">
              <div className="breadcrumb-wrapper justify-content-end">
                <ul className="breadcrumb justify-content-start justify-content-lg-end">
                  ...
                  <li className="breadcrumb-item active"> 304 Blaster Up</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="property-single-carousel mb-5">
          <div className="carousel-wrapper">
            <div className="owl-carousel owl-theme ps-carousel">
              <div className="item">
                <img src="../image/proparty-img/slide-2.jpg" alt="" className="img-fluid" />
              </div>
              <div className="item">
