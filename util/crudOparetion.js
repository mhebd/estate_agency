...
exports.findOne = (Model, populateOpt) =>
...
exports.findAll = (Model, populateOpt, sort) =>
  asyncHdl(async (req, res, next) => {
...
exports.createOne = (Model, options = {}) =>
  asyncHdl(async (req, res, next) => {
    ...
    return res
      .status(201)
      .json(new Result(true, 'Document Create Successfull!', { data }));
  });
...
exports.updateOne = (Model, options = {}) =>
  asyncHdl(async (req, res, next) => {
    ...
    return res
      .status(200)
      .json(new Result(true, 'Document Updated Successfull!', { data }));
  });
...
exports.deleteOne = (Model) =>
  asyncHdl(async (req, res, next) => {
    ...
    return res
      .status(200)
      .json(new Result(true, 'Document Deleted Successfull!', { data }));
  });
